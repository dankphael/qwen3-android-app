...
R"(kernel void kernel_mul_mm_q4_k_f32_l4_lm(
)"
...
R"(                float4 v1 = (convert_float4((uchar4)((q.s0 >> (b * 4))&0x0F, (q.s1 >> (b * 4))&0x0F, (q.s2 >> (b * 4))&0x0F, (q.s3 >> (b * 4))&0x0F)))*d + m;
)"
R"(
)"

...
R"(inline float block_q5_0_dot_y_flat(
)"
...
R"(    return d * (acc.s0 + acc.s1 + acc.s2 + acc.s3 + 16.0f * qh_sum - 16.0f * sumy);
)"
R"(}
)"
R"(
...
R"(    ulong offset0_qs = offset0 * (QK5_0/2);
)"
R"(
)"
...
R"(    global float * yb = y + ix * QK5_0 + il;
)"
R"(
)"
...
R"(        sumf.s0 += block_q5_0_dot_y_flat(x + ib*(QK5_0/2) + 0*nb*(QK5_0/2), qh + ib + 0*nb, d + ib + 0*nb, sumy, yl, il, yb);
)"
R"(        sumf.s1 += block_q5_0_dot_y_flat(x + ib*(QK5_0/2) + 1*nb*(QK5_0/2), qh + ib + 1*nb, d + ib + 1*nb, sumy, yl, il, yb);
)"
R"(        sumf.s2 += block_q5_0_dot_y_flat(x + ib*(QK5_0/2) + 2*nb*(QK5_0/2), qh + ib + 2*nb, d + ib + 2*nb, sumy, yl, il, yb);
)"
R"(        sumf.s3 += block_q5_0_dot_y_flat(x + ib*(QK5_0/2) + 3*nb*(QK5_0/2), qh + ib + 3*nb, d + ib + 3*nb, sumy, yl, il, yb);
)"
R"(
)"
R"(        yb += QK5_0 * (N_SIMDWIDTH/2);
)"
R"(    }
)"
R"(
...
R"(kernel void kernel_mul_mv_q5_0_f32_flat(
)"
R"(        global void * src0_qs,
)"
R"(        global void * src0_qh,
...
R"(    mul_vec_q_n_f32_flat(src0_qs, src0_qh, src0_d, src1, dst, ne00, ne01, ne02, ne10, ne12, ne0, ne1, r2, r3);
)"
R"(}
)"

...
R"(        *((global half *)(dst_ptr + i0*nb0)) = *((global half *)(src0_ptr + i0*nb00)) - *((global half *)(src1_ptr + i10*nb10));
)"
R"(    }
)"
R"(}
...
R"(kernel void kernel_sub_row_f16(
)"
R"(        global half4 * src0,
)"
R"(        ulong offset0,
...
R"(    src1 = (global half4*)((global char*)src1 + offset1);
)"

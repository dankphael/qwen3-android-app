...
R"(inline float block_q4_1_dot_y(
)"
R"(    global const struct block_q4_1 * qb_curr,
)"
R"(    float sumy,
)"
R"(    float16 yl,
...
R"(    global const ushort * qs = ((global const ushort *) qb_curr + 2 + il/2);
)"
R"(
)"
...
R"(    global struct block_q4_1 * x = (global struct block_q4_1 *) src0 + offset0;
)"
...
R"(        sumf.s0 += block_q4_1_dot_y(x+ib+0*nb, sumy, yl, il);
)"
R"(        sumf.s1 += block_q4_1_dot_y(x+ib+1*nb, sumy, yl, il);
)"
R"(        sumf.s2 += block_q4_1_dot_y(x+ib+2*nb, sumy, yl, il);
)"
R"(        sumf.s3 += block_q4_1_dot_y(x+ib+3*nb, sumy, yl, il);
)"
R"(
)"
...
R"(kernel void kernel_mul_mv_q4_1_f32(
)"
R"(        global void * src0,
)"
R"(        ulong offset0,

...
R"(static inline float8 q4_k_to_fp32_packed8(ushort2 q4x8, float scale, float minv) {
)"
R"(    float8 fp32x8;
)"
R"(    fp32x8.s0 = (q4x8.s0 & 0x000F) * scale - minv;
)"
R"(    fp32x8.s1 = ((q4x8.s0 & 0x00F0) >> 4) * scale - minv;
)"
R"(    fp32x8.s2 = ((q4x8.s0 & 0x0F00) >> 8) * scale - minv;
)"
R"(    fp32x8.s3 = ((q4x8.s0 & 0xF000) >> 12) * scale - minv;
)"
R"(    fp32x8.s4 = (q4x8.s1 & 0x000F) * scale - minv;
)"
R"(    fp32x8.s5 = ((q4x8.s1 & 0x00F0) >> 4) * scale - minv;
)"
R"(    fp32x8.s6 = ((q4x8.s1 & 0x0F00) >> 8) * scale - minv;
)"
R"(    fp32x8.s7 = ((q4x8.s1 & 0xF000) >> 12) * scale - minv;
)"
R"(    return fp32x8;
)"
R"(}
...
R"(__kernel void kernel_gemv_moe_q4_k_f32_ns(
)"
...
R"(        float8 fp32x8 = q4_k_to_fp32_packed8(as_ushort2(regQ.s0), scale, minv);
)"
R"(
)"
R"(        float4 shared_y4;
...
R"(        fp32x8 = q4_k_to_fp32_packed8(as_ushort2(regQ.s1), scale, minv);
)"
R"(
)"
...
R"(        fp32x8 = q4_k_to_fp32_packed8(as_ushort2(regQ.s2), scale, minv);
)"
R"(
)"
...
R"(        fp32x8 = q4_k_to_fp32_packed8(as_ushort2(regQ.s3), scale, minv);
)"
R"(
)"

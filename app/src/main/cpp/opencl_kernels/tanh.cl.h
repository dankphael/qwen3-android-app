...
R"(    dst[get_global_id(0)] = tanh(src0[get_global_id(0)]);
)"
R"(}
)"
R"(
)"
R"(kernel void kernel_tanh_f32_4(
)"
...
R"(kernel void kernel_tanh_f16_4(
)"
...
R"(kernel void kernel_tanh_f32_nc(
)"
...
R"(kernel void kernel_tanh_f16_nc(
)"
R"(        global const char * src0,
)"
R"(        ulong               offset0,

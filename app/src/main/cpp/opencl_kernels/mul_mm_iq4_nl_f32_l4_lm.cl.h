...
R"(kernel void kernel_mul_mm_iq4_nl_f32_l4_lm(
)"
...
R"(                // IQ4_NL: use lookup table instead of linear (nibble - 8)
)"
R"(                float4 v1 = (float4)(kvalues_iq4nl[(q.s0   )&0x0F], kvalues_iq4nl[(q.s1   )&0x0F],
)"
R"(                                     kvalues_iq4nl[(q.s2   )&0x0F], kvalues_iq4nl[(q.s3   )&0x0F])*d;
)"
R"(                float4 v2 = (float4)(kvalues_iq4nl[(q.s0>>4)&0x0F], kvalues_iq4nl[(q.s1>>4)&0x0F],
)"
R"(                                     kvalues_iq4nl[(q.s2>>4)&0x0F], kvalues_iq4nl[(q.s3>>4)&0x0F])*d;
)"
R"(
)"

...
R"(    dst[get_global_id(0)] = exp(src0[get_global_id(0)]);
)"
R"(}
)"
R"(
)"
R"(kernel void kernel_exp_f32_4(
)"
...
R"(kernel void kernel_exp_f16_4(
)"
...
R"(kernel void kernel_exp_f32_nc(
)"
...
R"(kernel void kernel_exp_f16_nc(
)"
R"(        global const char * src0,
)"
R"(        ulong               offset0,

...
R"(inline void mul_mv_mxfp4_f32(
)"
R"(    global char * src0,
)"
R"(    global char * src1,
...
R"(kernel void kernel_mul_mv_id_mxfp4_f32(
)"
R"(    global char * src0,
)"
R"(    ulong         offset0,
...
R"(    global char * src1_cur = src1 + i11*nb11 + i12*nb12;
)"
R"(
)"
...
R"(    mul_mv_mxfp4_f32(src0_cur, src1_cur, dst_cur,
)"
R"(        ne00, nb01, nb02, nb03, ne12, nb11, nb12, nb13, ne0, ne1, r2, r3, shmem);
)"
R"(}
)"

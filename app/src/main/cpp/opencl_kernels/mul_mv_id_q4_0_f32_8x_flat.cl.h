...
R"(kernel void kernel_mul_mv_id_q4_0_f32_8x_flat(
)"
R"(        global char  *  src0_q,
)"
R"(        global half  *  src0_d,
...
R"(    const int i02 = ((global int *)(src2 + iid1*nb21))[idx];
)"
R"(
)"
R"(    const int i11 = idx%ne11;
)"
R"(    const int i12 = iid1;
)"
R"(
)"
R"(    const int i1 = idx;
...
R"(    global char  * src0_q_cur = src0_q + (i02*nb02/nb00)*(QK4_0/2);
)"
R"(    global half  * src0_d_cur = src0_d + (i02*nb02/nb00);
)"
R"(    global float * src1_cur   = (global float *)((global char *) src1  + i11*nb11 + i12*nb12);
)"
R"(    global float * dst_cur    = dst + i1*ne0 + i2*ne1*ne0;
)"
R"(
)"
R"(    mul_vec_q_n_f32_8x_flat(src0_q_cur, src0_d_cur, src1_cur, dst_cur, ne00, ne01, ne02, ne10, ne12, ne0, ne1, r2, r3);
)"
R"(}
)"

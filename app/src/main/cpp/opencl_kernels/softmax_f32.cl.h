...
R"(    global float * psrc0 = (global float *)(src0 + i01*nb01 + i02*nb02 + i03*nb03);
)"
R"(    global float * pmask = src1 != src0 ? (global float *)(src1 + i11*nb11 + i12*nb12 + i13*nb13) : 0;
)"
R"(    global float * psrc2 = src2 != src0 ? (global float *)(src2) : 0;
)"
R"(    global float * pdst  = (global float *)(dst  + i01*nb1 + i02*nb2 + i03*nb3);
)"
R"(
)"
R"(    float slope = 1.0f;
...
R"(    float lmax = psrc2 ? psrc2[i02] : -INFINITY;
)"

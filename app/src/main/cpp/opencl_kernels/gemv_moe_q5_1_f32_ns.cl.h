...
R"(static inline float8 q5_1_to_fp32_packed8(ushort2 qs5x8, uchar qh5x8, half s, half m) {
)"
R"(    float8 fp32x8;
)"
...
R"(__kernel void kernel_gemv_moe_q5_1_f32_ns(
)"
...
R"(    for (uint ib00 = sgid; ib00 < (ne00 / QK_Q5_1); ib00 += N_SIMDGROUP) {
)"
R"(
)"
...
R"(        float8 fp32x8 = q5_1_to_fp32_packed8(as_ushort2(regQ.s0), regQh.s0, regS, regM);
)"
R"(
)"
R"(        float4 shared_y4;
...
R"(        fp32x8 = q5_1_to_fp32_packed8(as_ushort2(regQ.s1), regQh.s1, regS, regM);
)"
R"(
)"
...
R"(        fp32x8 = q5_1_to_fp32_packed8(as_ushort2(regQ.s2), regQh.s2, regS, regM);
)"
R"(
)"
...
R"(        fp32x8 = q5_1_to_fp32_packed8(as_ushort2(regQ.s3), regQh.s3, regS, regM);
)"
R"(
)"

...
R"(kernel void kernel_expm1_f32(
)"
...
R"(    dst[get_global_id(0)] = exp(src0[get_global_id(0)]) - 1.0f;
)"
R"(}
)"
R"(
)"
R"(kernel void kernel_expm1_f32_4(
)"
...
R"(kernel void kernel_expm1_f16(
)"
...
R"(    dst[get_global_id(0)] = exp(src0[get_global_id(0)]) - 1.0h;
)"
R"(}
)"
R"(
)"
R"(kernel void kernel_expm1_f16_4(
)"
...
R"(kernel void kernel_expm1_f32_nc(
)"
...
R"(kernel void kernel_expm1_f16_nc(
)"
R"(        global const char * src0,
)"
R"(        ulong               offset0,

...
data class ModelMetadata(
    ...
    val totalLayers: Int = 0  // 0 = auto-detect from model file at load time
) {
    companion object {
        val ALL = listOf(
            ModelMetadata(
                ...
                maxTokens = 1024,
                temperature = 0.7f,
                totalLayers = 28  // Qwen3.5-0.8B has 28 layers
            ),
            ModelMetadata(
                key = "qwen3.5-2b",
                ...
                maxTokens = 1024,
                temperature = 0.7f,
                totalLayers = 36  // Qwen3.5-2B has 36 layers
            ),
            ModelMetadata(
                key = "qwen3.5-4b",
                ...
                maxTokens = 2048,
                temperature = 0.7f,
                totalLayers = 40  // Qwen3.5-4B has 40 layers
            ),
        )
